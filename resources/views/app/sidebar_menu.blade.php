    ...
    <aside class="sidebar" id="sidebar">
        ...
        @if (auth()->user()->hasRole(Role::ROLE_USER))
            <nav class="sidebar-nav">
                ...
                <div class="menu-section">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('user_messages') }}">
                                <i class="bi bi-calendar-event"></i>
                                <span>Messages</span>
                            </a>
                        </li>
        ...
        @elseif (auth()->user()->hasRole(Role::ROLE_ADMIN))
            <nav class="sidebar-nav">
                <div class="menu-section">
                    <div class="menu-section-title">Main</div>
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('manage_all_users') }}">
                                <i class="bi bi-calendar-event"></i>
                                <span>All Users</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('manage_client_listings') }}">
                                <i class="bi bi-calendar-event"></i>
                                <span>All Listings</span>
                            </a>
                        </li>
